# This is a program to return genes of interest from QTL intervals
...
path.km<-paste(dir.trait, '/known_markers.out', sep="")

# specify path of MQM file
mqm.qtl<-paste(dir.trait, '/mqm.out/', 'summary.table.mqm.', trait, ".csv", sep="")
km.qtl<-paste(dir.trait, '/known_markers.out/', 'summary.table.so.', trait, ".csv", sep="")
